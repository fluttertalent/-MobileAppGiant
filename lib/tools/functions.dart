...
Widget buildIconButton(
    Icon icon, String title, String description, void Function() func,
    {double width = 300}) {
  ...
  final text = Text(title,
      style: robotoStyle(
          FontWeight.w700, const Color.fromARGB(255, 49, 48, 54), 16, null),
      textAlign: TextAlign.center);
  final descript = Text(description,
      style: robotoStyle(
  ...
  return Container(
    ...
    child: ElevatedButton(
        ...
        child: Stack(
          children: [
            Align(alignment: const Alignment(-1, -0.5), child: text),
            Align(alignment: const Alignment(-1, 0.5), child: descript),
...
Widget buildSimpleButton(String title, void Function() func,
    {double width = 150}) {
  final buttonStyle = ButtonStyle(
      elevation: MaterialStateProperty.all<double>(0.0),
...
Widget buildFloatingButtonMainCalendar(
    String title, Color backgroundColor, Color textColor, void Function() func,
    {double width = 115}) {
  final buttonStyle = ButtonStyle(
  ...
  final text = Text(title,
      style: robotoStyle(FontWeight.w800, textColor, null, null),
      textAlign: TextAlign.center);
  return Container(
...
Widget buildImageButton(String image, double imageSize, String title,
    double spaces, void Function() func,
    {double width = 265}) {
  return Container(
    padding: const EdgeInsets.only(bottom: 15, top: 5),
    width: 265,
    ...
    child: InkWell(
      ...
      child: Ink(
        ...
        child: Padding(
          padding:
              const EdgeInsets.only(bottom: 15, top: 15, right: 0, left: 40),
          child: Wrap(
            ...
            children: [
              ...
              Text(
                title,
                style:
                    robotoStyle(FontWeight.w500, Colors.grey[700], null, null),
              ),
            ],
          ),
        ),
...
Widget calendarDateBarUpcoming(Map upcoming) {
  // print(upcoming);
  // dev.log(prettyJson(jsonDecode(upcoming)));
  return Container(
    height: 40,
    ...
    child: Row(
      ...
      children: [
        Text(
          upcoming.keys.first.toString().split(',')[0],
          style: robotoStyle(FontWeight.w400, Colors.white, 24, null),
        ),
        Text(
          '${upcoming.keys.first.toString().split(',')[1]},',
          style: robotoStyle(FontWeight.w900, Colors.white, 24, null),
        ),
        Text(
          upcoming.keys.first.toString().split(',')[2],
          style: robotoStyle(FontWeight.w400, Colors.white, 24, null),
        ),
        // Text(" ${getCurrentMonthUpcoming(n)}",
        //     style: robotoStyle(FontWeight.w900, Colors.white, 20, null)),
        // Text(" ${getCurrentDayNbUpcoming(n)}",
        //     style: robotoStyle(FontWeight.w900, Colors.white, 20, null)),
        // Text(", ${getCurrentYearUpcoming(n)}",
...
Widget calendarDateBarPast(int n) {
  return Container(
    ...
    child: Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Text(getCurrentDayLetterPast(n),
            style: robotoStyle(FontWeight.w400, Colors.white, 20, null)),
        Text(" ${getCurrentMonthPast(n)}",
            style: robotoStyle(FontWeight.w900, Colors.white, 20, null)),
        Text(" ${getCurrentDayNbPast(n)}",
            style: robotoStyle(FontWeight.w900, Colors.white, 20, null)),
        Text(", ${getCurrentYearPast(n)}",
            style: robotoStyle(FontWeight.w400, Colors.white, 20, null)),
      ],
    ),
  );
